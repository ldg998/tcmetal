...
function jqGrid_main() {
    $('#mes_grid').jqGrid({
        ...
        colModel: [
            ...
            {name: 'date3', index: 'date3', sortable: false, fixed:true, width:100},
            {name: 'date4', index: 'date4', sortable: false, fixed:true, width:100},
            {name: 'date5', index: 'date5', sortable: false, fixed:true, width:100},
            {name: 'date6', index: 'date6', sortable: false, fixed:true, width:100},
            {name: 'date7', index: 'date7', sortable: false, fixed:true, width:100},
            {name: 'date8', index: 'date8', sortable: false, fixed:true, width:100},
            {name: 'date9', index: 'date9', sortable: false, fixed:true, width:100},
            {name: 'date10', index: 'date10', sortable: false, fixed:true, width:100}
