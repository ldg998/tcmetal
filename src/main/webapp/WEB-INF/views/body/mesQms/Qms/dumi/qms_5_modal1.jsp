...
<script type="text/javascript" src="/data-component/mesQMS/Qms/dumi/qms_5_modal1.js"
...
<div id="addDialog" title="출하검사현황" style="display: none">
    ...
    <div class="profile-user-info profile-user-info-striped">
        ...
        <div class="profile-info-row">
            <div class="profile-info-name">검사항목</div> <div class="profile-info-name lin2" style="width: 20%">체크</div>
        </div>
        <div class="profile-info-row">
            <div class="profile-info-value">
                <input type="text" name="" class="form-control modal_value" autocomplete="off">
            </div>
            <div class="profile-info-value lin2" >
                <input type="text" name="" class="form-control modal_value" autocomplete="off">
            </div>
        </div>
        <div class="profile-info-row">
