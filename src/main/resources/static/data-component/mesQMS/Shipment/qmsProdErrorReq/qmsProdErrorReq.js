...
function jqGrid_main() {
    ...
    $('#mes_grid').jqGrid({
        ...
        colModel: [
            {name: 'act_type', index: 'act_type',fixed: true,hidden:true},
            {name: 'file1_code', index: 'file1_code',fixed: true,hidden:true},
            {name: 'file2_code', index: 'file2_code',fixed: true,hidden:true},
            {name: 'supp_code', index: 'supp_code',fixed: true,hidden:true},
            {name: 'part_code', index: 'part_code',fixed: true,hidden:true},
            {name: 'part_kind', index: 'part_kind',fixed: true,hidden:true},
            {name: 'report_type', index: 'report_type',fixed: true,hidden:true},
            {name: 'ret_user_code', index: 'ret_user_code',fixed: true,hidden:true},
            {name: 'ret_dept_code', index: 'ret_dept_code',fixed: true,hidden:true},
            {name: 'work_date', index: 'work_date', width: 90,fixed: true , formatter: formmatterDate2},
            {name: 'ret_no', index: 'ret_no',key:true, width: 130,fixed: true},
            ...
            {name: 'ng_type', index: 'ng_type', width: 120,fixed: true},
            {name: 'ng_name', index: 'ng_name', width: 150,fixed: true},
            {name: 'report_date', index: 'report_date', width: 90,fixed: true ,formatter: formmatterDate2},
            {name: 'measuer_name', index: 'measuer_name', width: 140,fixed: true},
            {name: 'act_date', index: 'act_date', width: 90,fixed: true,formatter: formmatterDate2},
            {name: 'act_type_name', index: 'act_type_name', width: 70,fixed: true},
            {name: 'file1_ck', index: 'file1_ck', width: 70,fixed: true,formatter: file1_formatter},
            {name: 'file2_ck', index: 'file2_ck', width: 60,fixed: true,formatter: file2_formatter},
