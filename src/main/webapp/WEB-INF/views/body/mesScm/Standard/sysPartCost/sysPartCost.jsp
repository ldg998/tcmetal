...
<script type="text/javascript" src="/data-component/mesSCM/Standard/sysPartCost/sysPartCost.js" charset="UTF-8"></script> <%--스크립트 파일 import--%>
...
<!-- 모달창 import -->
<%@include file="sysPartCost_modal1.jsp"%>
