...
function jqGrid_main() {
    $("#mes_grid").jqGrid({
        ...
        colModel: [
            ...
            {name: 'unit_name', index: 'unit_name', sortable: false, width: 70,fixed:true},
            {name: 'qc_level_name', index: 'qc_level_name', sortable: false, width: 80,fixed:true},
            {name: 'in_qty', index: 'in_qty', sortable: false, width: 90, align: 'right',formatter:'integer',fixed:true},
            {name: 'qc_qty', index: 'qc_qty', sortable: false, width: 90, align: 'right',formatter:'integer',fixed:true},
            {name: 'ng_qty', index: 'ng_qty', sortable: false, width: 90, align: 'right',formatter:'integer',fixed:true},
            {name: 'qc_result_name', index: 'qc_result_name', sortable: false, width: 70,fixed:true},
    ...
    $('#mes_grid2').jqGrid({
        ...
        colModel: [
            {name: 'work_date', index: 'work_date', width: 80, sortable: false,formatter:formatterDate4,fixed:true},
            {name: 'qc_qty', index: 'qc_qty', width: 90, sortable: false, align: 'right',formatter:'integer',fixed:true},
            {name: 'ng_qty', index: 'ng_qty', width: 90, sortable: false, align: 'right',formatter:'integer',fixed:true},
            {name: 'qc_ratio', index: 'qc_ratio', width: 80, sortable: false,align:'right',fixed:true}
        ],
        autowidth: true,
        height: 349,
        rowNum: 100,
