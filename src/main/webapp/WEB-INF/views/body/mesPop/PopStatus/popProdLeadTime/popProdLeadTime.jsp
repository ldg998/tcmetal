...
<script type="text/javascript" src="/data-component/mesPOP/PopStatus/popProdLeadTime/popProdLeadTime.js" charset="UTF-8"></script>
            ...
            <div class="col-lg-4 col-md-12 padding0">
                <table class="table wt-100 margin-bottom-3">
                    ...
                    <tr>
                        ...
                        <td class="wt-px-200">
                            <select id="select2" name="keyword2" class="condition_main" style="width: 100%">
