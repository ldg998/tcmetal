...
function jqGrid_main() {
    $('#mes_grid').jqGrid({
        ...
        colModel: [
            {name: 'work_date', index: 'work_date', width: 90,sortable:false,fixed:true, formatter:formmatterDate2},
            ...
            {name: 'stock_qty_prev', index: 'stock_qty_prev', width: 90,sortable:false,fixed:true, align:'right', formatter:'integer'},
            {name: 'stock_qty', index: 'stock_qty', width: 90,sortable:false,fixed:true,align:'right',formatter:'integer'},
            {name: 'rev_name', index: 'rev_name', width: 60, sortable:false,fixed:true},
            {name: 'user_name', index: 'user_name', width: 60, sortable:false,fixed:true},
