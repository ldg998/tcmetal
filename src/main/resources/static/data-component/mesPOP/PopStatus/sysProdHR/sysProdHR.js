...
function jqGrid_main() {
    $('#mes_grid').jqGrid({
        ...
        colModel: [
            ...
            {name: 'wk_qty2', index: 'wk_qty2', sortable: false, width: 90,fixed:true,align: 'right', formatter: 'integer'},
            {name: 'wk_qty3', index: 'wk_qty3', sortable: false, width: 90,fixed:true,align: 'right', formatter: 'integer'},
            {name: 'wk_qty_sum1', index: 'wk_qty_sum1', sortable: false, width: 90,fixed:true,align: 'right', formatter: 'integer'},
            {name: 'wk_qty4', index: 'wk_qty4', sortable: false, width: 90,fixed:true,align: 'right', formatter: 'integer'},
            {name: 'wk_qty5', index: 'wk_qty5', sortable: false, width: 90,fixed:true,align: 'right', formatter: 'integer'},
            {name: 'wk_qty_sum2', index: 'wk_qty_sum2', sortable: false, width: 90,fixed:true,align: 'right', formatter: 'integer'},
