...
<%@ page session="false" %>
<script type="text/javascript" src="/data-component/mesPOP/PopStatus/popProdAnalysis/popProdAnalysis.js"
                ...
                <table class="table wt-100 margin-bottom-3">
                    ...
                    <td class="wt-px-200">
                        <select id='select1' name="keyword" class="form-control h-25 condition_main"
                                onchange="main_select_change1(this.value)" style="width: 100%;">
