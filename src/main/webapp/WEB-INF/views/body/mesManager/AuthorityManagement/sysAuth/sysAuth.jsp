...
<script type="text/javascript" src="/data-component/mesManager/Auth/sysAuth/sysAuth.js" charset="UTF-8"></script> <!-- 스크립트 파일 import -->
            ...
            <div class="pull-left tableTools-container">
                <div class="dt-buttons btn-overlap btn-group">
                    ...
                    <a id="get_btn" class="dt-button buttons-collection buttons-colvis btn btn-white btn-primary btn-mini btn-bold"
                       tabindex="0" aria-controls="dynamic-table" onclick="get_btn(1);">
                        <span><i class="fa fa-search bigger-110 blue"></i><span>조회</span></span>
                    </a>
                    <!-- 추가버튼 -->
...
<!-- 모달창 import -->
<%@include file="sysAuth_modal1.jsp"%>
