...
function jqGrid_main() {
    $('#mes_grid').jqGrid({
        ...
        colModel: [
            ...
            {name: 'rev_no', index: 'rev_no',  width: 120, fixed:true},
            ...
            {name: 'stock_qty_prev', index: 'stock_qty_prev',  width: 90, fixed:true,align:'right',formatter:'integer'},
            {name: 'stock_qty', index: 'stock_qty',  width: 90, fixed:true,align:'right',formatter:'integer'},
