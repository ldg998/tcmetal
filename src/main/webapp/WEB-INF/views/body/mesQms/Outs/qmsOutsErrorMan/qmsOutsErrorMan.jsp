...
<%@ page session="false" %>
<script type="text/javascript" src="/data-component/mesQMS/Outs/qmsOutsErrorMan/qmsOutsErrorMan.js" charset="UTF-8"></script>
...
<%@include file="qmsQutsErrorMan_modal1.jsp" %>
