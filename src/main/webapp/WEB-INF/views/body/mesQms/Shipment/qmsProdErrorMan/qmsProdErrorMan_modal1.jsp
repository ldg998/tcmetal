...
<script type="text/javascript" src="/data-component/mesQMS/Shipment/qmsProdErrorMan/qmsProdErrorMan_modal1.js" charset="UTF-8"></script>
<style>
    .filebox label {
...
<div id="addDialog" title="최종검사부적합등록" style="display:none">
