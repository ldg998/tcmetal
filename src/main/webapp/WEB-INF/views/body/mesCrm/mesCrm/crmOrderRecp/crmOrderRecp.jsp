...
<script type="text/javascript" src="/data-component/mesCRM/mesCrm/crmOrderRecp/crmOrderRecp.js" charset="UTF-8"></script>
...
<div class="main-content-inner">
    <div class="page-content">
        <div class="col-lg-12 padding0">
            <div class="col-lg-4 col-md-12  padding0 border_top">
...
<%@include file="crmOrderRecp_modal2.jsp" %>
