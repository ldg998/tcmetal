...
function get_btn(page) {
    ...
    main_data.send_data.keyword = $('#place_name').val();
...
function update_btn(data) {
    if (main_data.auth.check_edit !="N") {
        ...
        var div3 =$(" <input type='hidden' class='modal_value' name='plan_no' value='"+data.plan_no+"'> \n");
                 $("#wrapper").after(div3);
    } else {
...
function jqGrid_main() {
    $('#mes_grid').jqGrid({
        ...
        colModel: [
            {name: 'plan_date', index: 'plan_date', sortable: false, width: 100, formatter: formmatterDate2, fixed: true},
            ...
            {name: 'route_name', index: 'route_name', sortable: false, width: 100, fixed: true},
