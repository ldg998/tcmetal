...
<%@ page session="false" %>
<script type="text/javascript" src="/data-component/mesQMS/Interim/qmsAssyErrorMan/qmsAssyErrorMan.js" charset="UTF-8"></script>
...
<%@include file="qmsAssyErrorMan_modal1.jsp" %>
