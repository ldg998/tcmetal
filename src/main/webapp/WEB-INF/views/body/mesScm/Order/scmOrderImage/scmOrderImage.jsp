...
<script type="text/javascript" src="/data-component/mesSCM/Order/scmOrderImage/scmOrderImage.js" charset="UTF-8"></script><!-- 스크립트 파일 import -->
...
<!-- 모달창 import -->
<%@include file="scmOrderImage_modal1.jsp" %>
