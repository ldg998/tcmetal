...
function jqGrid_main() {
    $("#mes_grid").jqGrid({
        ...
        colModel : [
            ...
            {name:'result_code3_name',index:'result_code3_name',sortable: false,width:190,fixed: true},
            {name:'user_name',index:'user_name',sortable: false,width:60,fixed: true},
            {name:'create_date',index:'create_date',formatter:formmatterDate,sortable: false,width:140,fixed: true}
        ],
        multiselect: true,
        caption: "외주불량 | MES",
        autowidth: true,
