...
function jqGrid_main() {
    $("#mes_grid").jqGrid({
       ...
       colModel: [
           ...
           {name: 'part_kind', index: 'part_kind', sortable: false,fixed:true,width:110},
           ...
           {name: 'part_weight', index: 'part_weight', sortable: false,fixed:true,width:90,align:'right',formatter:'integer'},
           {name: 'qty', index: 'qty', sortable: false,fixed:true,width:90,align:'right',formatter:'integer'},
       ],
        autowidth: true,
        viewrecords: true,
        height: 562,
