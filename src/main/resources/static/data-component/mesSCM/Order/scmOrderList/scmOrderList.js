...
function jqGrid_main() { //메인그리드 설정
    $('#mes_grid').jqGrid({
        ...
        colModel: [
            {name: 'work_date', index: 'work_date',  formatter: formmatterDate2,fixed:true, width:90},
            {name: 'ord_no', index: 'ord_no', fixed:true, width:120},
            ...
            {name: 'ord_qty', index: 'ord_qty', formatter:'integer', align: 'right',fixed:true, width:90},
            {name: 'qty', index: 'qty', formatter:'integer', align: 'right',fixed:true, width:90},
            {name: 'not_qty', index: 'not_qty',  formatter:'integer', align: 'right',fixed:true, width:90},
