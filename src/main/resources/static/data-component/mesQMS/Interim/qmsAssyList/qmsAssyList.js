...
function get_btn(page) {
    ...
    main_data.send_data.start_date = main_data.send_data.start_date.replace(/\-/g, '').concat('000000');
    main_data.send_data.end_date = main_data.send_data.end_date.replace(/\-/g, '').concat('999999');
...
function authcheck() {
    ccn_ajax("/menuAuthGet", {keyword: "qmsAssyList"}).then(function (data) {
        main_data.auth = data;
    });
}
...
function jqGrid_main() {
    $('#mes_grid').jqGrid({
        ...
        colModel: [
            ...
            {name: 'file2_name', index: 'file2_name',sortable: false,width: 100, align: 'center',
                formatter: file2_formatter,fixed:true
            },
            {name: 'file3_name',index: 'file3_name',sortable: false,width: 100,align: 'center',
