...
<script type="text/javascript" src="/data-component/mesWMS/Stock/wmsStockSumMonth/wmsStockSumMonth.js" charset="UTF-8"></script>
            ...
            <div class="col-lg-4 col-md-12 padding0">
                <table class="table wt-100 margin-bottom-3">
                    ...
                    <tr>
                        ...
                        <td class="wt-px-200">
                            <select id="part_kind_select" class="form-control condition_main" onchange="select_change2(this.value)"  name="keyword2" style="width: 100%;">
