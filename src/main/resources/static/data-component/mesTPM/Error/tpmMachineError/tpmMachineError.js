...
function jqGrid_main() {
    $('#mes_grid').jqGrid({
        ...
        colModel: [
            ...
            {name: 'error_name', index: 'error_name', sortable: false, width: 130,fixed:true},
            {name: 'code_name1', index: 'code_name1', sortable: false, width: 120,fixed:true},
            {name: 'cn', index: 'cn', sortable: false, width: 120,fixed:true},
            ...
            {name: 'check_date', index: 'check_date', sortable: false, width: 140, formatter: formmatterDate,fixed:true}
        ],
        multiselect: true,
        caption: '사후보전관리 | MES',
        autowidth: true,
