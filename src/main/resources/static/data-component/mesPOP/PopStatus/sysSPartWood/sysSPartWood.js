...
function jqGrid_main() {
    $("#mes_grid").jqGrid({
        ...
        colModel: [
            ...
            {name: 'wood_supp_name', index: 'wood_supp_name', sortable:false, width: 70, fixed:true},
            {name: 'wood_in_date', index: 'wood_in_date', sortable:false, width: 90, fixed:true, formatter:formmatterDate2},
            {name: 'wood_remark', index: 'wood_remark', sortable:false, width: 300, fixed:true},
