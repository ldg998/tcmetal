...
function jqGrid_main() {
    $('#mes_grid').jqGrid({
        ...
        colModel: [
            {name: 'rownum', index: 'rownum',  key:true, width: 150,fixed: true,hidden:true},
            {name: 'seq', index: 'seq',  width: 50, fixed: true,hidden:true},
            {name: 'work_date', index: 'work_date',  width: 100, fixed: true,formatter:formmatterDate2},
            {name: 'charge', index: 'charge',  width: 100, fixed: true,align:'right',formatter:'integer'},
            {name: 'line_grp_code', index: 'line_grp_code',  width: 150, fixed: true,hidden:true},
            {name: 'line_code', index: 'line_code',  width: 150, fixed: true,hidden:true},
            {name: 'line_name', index: 'line_name',  width: 150, fixed: true},
            ...
            {name: 'part_weight', index: 'part_weight',  width: 100, fixed: true,align:'right',formatter:'integer'},
            {name: 'plan_qty', index: 'plan_qty',  width: 100, fixed: true,align:'right',formatter:'integer'},
            {name: 'weight', index: 'weight',  width: 100, fixed: true,align:'right',formatter:'integer'},
            {name: 'status_name', index: 'status_name',  width: 50, fixed: true},
            {name: 'mat_group', index: 'mat_group',  width: 150, fixed: true},
            {name: 'work_user_name', index: 'work_user_name',  width: 100, fixed: true}
