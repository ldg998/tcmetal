...
function jqGrid_main() {
    $("#mes_grid").jqGrid({
        ...
        colModel: [
            {name: 'file_key', index: 'file_key', hidden:true},
            ...
            {name: 'hard1', index: 'hard1', width: 40, fixed:true,align: 'right', formatter: 'integer' },
            {name: 'hard2', index: 'hard2', width: 40, fixed:true,align: 'right', formatter: 'integer' },
            {name: 'hard3', index: 'hard3', width: 40, fixed:true,align: 'right', formatter: 'integer' },
            {name: 'qc_result_name', index: 'qc_result_name', width: 60, fixed:true},
            {name: 'filename', index: 'filename', width: 70, fixed:true ,formatter:image_formatter},
            {name: 'file1', index: 'file1', width: 70, fixed:true, formatter: file3_formatter},
