...
function jqGrid_main() {
    $('#mes_grid').jqGrid({
        ...
        colModel: [
            ...
            {name: 'charge', index: 'charge', sortable: false, width: 80,fixed:true},
            ...
            {name: 'test_value1', index: 'test_value1', sortable: false, width: 80,fixed:true,align: 'right', formatter: 'number'},
            {name: 'test_value2', index: 'test_value2', sortable: false, width: 80,fixed:true,align: 'right', formatter: 'number'},
            {name: 'test_value3', index: 'test_value3', sortable: false, width: 80,fixed:true,align: 'right', formatter: 'number'},
            {name: 'test_value4', index: 'test_value4', sortable: false, width: 80,fixed:true,align: 'right', formatter: 'number'},
            {name: 'test_value5', index: 'test_value5', sortable: false, width: 80,fixed:true,align: 'right', formatter: 'number'},
            {name: 'test_value6', index: 'test_value6', sortable: false, width: 80,fixed:true,align: 'right', formatter: 'number'},
            {name: 'test_value7', index: 'test_value7', sortable: false, width: 80,fixed:true,align: 'right', formatter: 'number'},
            {name: 'test_value8', index: 'test_value8', sortable: false, width: 80,fixed:true,align: 'right', formatter: 'number'},
            {name: 'test_value9', index: 'test_value9', sortable: false, width: 80,fixed:true,align: 'right', formatter: 'number'},
