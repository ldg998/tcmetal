...
function jqGrid_main() {
    ...
    $('#mes_grid').jqGrid({
        ...
        colModel: [
            {name: 'machine_code', index: 'machine_code', width: 100,fixed: true, key:true},
            {name: 'machine_name', index: 'machine_name', width: 150,fixed: true},
            {name: 'device_no', index: 'device_no', width: 100,fixed: true},
            {name: 'capa', index: 'capa', width: 150,fixed: true},
            {name: 'spec', index: 'spec', width: 150,fixed: true},
            {name: 'correct_corp_name', index: 'correct_corp_name', width: 150,fixed: true},
            {name: 'correct_date', index: 'correct_date', width: 100,fixed: true,formatter:formmatterDate2},
            {name: 'end_date', index: 'end_date', width: 100,fixed: true,formatter:formmatterDate2},
            {name: 'alarm_day', index: 'alarm_day', width: 100,fixed: true},
            {name: 'file1_name', index: 'file1_name',  width: 80, align: 'center', formatter:file1_formatter,fixed:true},
            {name: 'file1', index: 'file1', hidden: true},
