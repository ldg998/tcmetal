...
function get_btn(page) {
    ...
    main_data.send_data.keyword = '2';  //QC_RESULT
    main_data.send_data.keyword2 = '';  //QC_NO
    main_data.send_data.keyword3 = '4'; //QC_GROUP
...
function authcheck() {
    ccn_ajax("/menuAuthGet", {keyword: "qmsOutsErrorList"}).then(function (data) {
        main_data.auth = data;
    });
}
function selectBox() {
