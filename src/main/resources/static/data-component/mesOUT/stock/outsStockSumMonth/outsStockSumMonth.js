...
function jqGrid_main() {
    $("#mes_grid").jqGrid({
        ...
        colModel : [// grid row 의 설정할 데이터 설정
            {name:'outs_supp_name',index:'outs_supp_name',key: true ,sortable: false,width:130,fixed: true},// key 지정시 grid에서 rowid 데이터 추출시 해당 데이터로 추출
            ...
            {name:'prev_qty',index:'prev_qty',sortable: false,width:90,fixed: true,align: 'right', formatter: 'integer'},
            {name:'in_qty',index:'in_qty',sortable: false,width:90,fixed: true,align: 'right', formatter: 'integer'},
            {name:'out_qty',index:'out_qty',sortable: false,width:90,fixed: true,align: 'right', formatter: 'integer'},
            {name:'ng_qty',index:'ng_qty',sortable: false,width:90,fixed: true ,align: 'right', formatter: 'integer'},
            {name:'qty',index:'qty',sortable: false,width:90,fixed: true,align: 'right', formatter: 'integer'}// formatter 사용을 통해 데이터 형식 가공
        ],
