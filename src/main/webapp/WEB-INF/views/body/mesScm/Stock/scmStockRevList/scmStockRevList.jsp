...
<script type="text/javascript" src="/data-component/mesSCM/Stock/scmStockRevList/scmStockRevList.js"
        ...
        <div class="col-lg-12 padding0">
            <table class="table wt-100 board_line">
                ...
                <tr>
                    ...
                    <td class="wt-px-200">
                        <select name="keyword" id="1_select" class="form-control keyword condition_main" style="width:100%">
