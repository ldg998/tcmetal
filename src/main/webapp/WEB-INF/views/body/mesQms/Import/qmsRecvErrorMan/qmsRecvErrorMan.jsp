...
<script type="text/javascript" src="/data-component/mesQMS/Import/qmsRecvErrorMan/qmsRecvErrorMan.js" charset="UTF-8"></script>
...
<%@include file="qmsRecvErrorMan_modal1.jsp" %>
