...
function jqGrid_main() {
    $("#mes_grid").jqGrid({
        ...
        colNames : ['외주업체','업체','기종','품번','품명','단중','수량'],// grid 헤더 설정
        colModel : [// grid row 의 설정할 데이터 설정
            ...
            {name:'qty',index:'qty',sortable: false,width:80,fixed: true,align: 'right', formatter: 'integer'}// formatter 사용을 통해 데이터 형식 가공
        ],

        caption: "외주재고현황 | MES",// grid 제목
