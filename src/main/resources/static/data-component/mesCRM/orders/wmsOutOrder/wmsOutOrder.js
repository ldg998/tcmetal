...
function jqGrid_main() {
    $('#mes_grid').jqGrid({
        ...
        colModel: [
            ...
            {name: 'ord_no', index: 'ord_no', sortable: false,hidden:true, width: 80,fixed:true},
            ...
            {name: 'ord_date', index: 'ord_date', sortable: false, width: 90,formatter: formmatterDate2,fixed:true  },
